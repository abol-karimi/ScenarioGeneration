...
behavior FollowRouteAvoidCollisionsBehavior(route_lanes, target_speed=3, turn_speed=2):
    try:
        do FollowTrajectoryBehavior(target_speed, route_lanes, turn_speed)
...
behavior IntersectionBehavior(route_lanes, target_speed=3, turn_speed=2, arrival_distance=4):
    do FollowRouteAvoidCollisionsBehavior(route_lanes, target_speed, turn_speed)\
