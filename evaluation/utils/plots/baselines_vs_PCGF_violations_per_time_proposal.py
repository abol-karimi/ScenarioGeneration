...
def plot(plot_configs):
  ...
  for plot_config in plot_configs:
    gen_config = plot_config['gen-config']
    test_config = plot_config['test-config']
  ...
  fig_coverage.savefig(f'evaluation/results/ISSTA_plots/baseline-vs-PCGF_{test_coverage}_violations_per-time.png')
